/*
  ...
  Çalıştırma:  npm run eposta-ayarla   (ya da node araclar/eposta-ayarla.js)
...
const eposta = require('../sunucu/yardimci/eposta');
...
async function calistir() {
  ...
  console.log('  Sunucu calisiyorsa KAPATIP yeniden baslat (npm start).');
  console.log('');
  rl.close();
}
